...
import 'package:startyourtour/agent/quotedetailscreen/quoteservice.dart';
import 'package:startyourtour/widgets/customlinewidget.dart';

class QuoteItinerary extends StatefulWidget {
  @override
  _QuoteItineraryState createState() => _QuoteItineraryState();
}

class _QuoteItineraryState extends State<QuoteItinerary> {
  bool checkval = false;
  @override
